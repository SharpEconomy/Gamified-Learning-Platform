          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-lg md:text-xl text-pink-200/90 max-w-2xl mx-auto mb-10 leading-relaxed">
                See who's dominating the coding challenges and climbing the
                ranks!
              </p>
            </div>
          </div>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-purple-500/30">
                          <th className="text-left py-4 px-6 text-sm font-semibold text-purple-200">
                            Rank
                          </th>
                          <th className="text-left py-4 px-6 text-sm font-semibold text-purple-200">
                            Learner
                        ...
                        {leaderboardData.map((entry, index) => (
                          ...
                          >
                            <td className="py-4 px-6">
                              <div className={`flex items-center gap-3`}>
                                <div
                                  className={`w-10 h-10 rounded-full flex items-center justify-center text-lg font-bold ${entry.rank <= 3 ? "bg-gradient-to-br " + getRankClass(entry.rank) + " text-white shadow-lg" : "bg-purple-500/20 text-purple-300"}`}
                                >
