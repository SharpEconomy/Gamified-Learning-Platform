...
const courses = [
  ...
  },
  {
    ...
    description:
      "Learn Python programming from scratch to building applications",
    icon: "🐍",
    lessons: 35,
    xp: 3500,
...
const features = [
  {
    ...
    description:
      "Write and run code directly in your browser with real-time feedback",
  ...
  },
  {
    ...
    description:
      "Level up as you complete lessons and unlock achievement badges",
...
const testimonials = [
  {
    ...
    avatar: "👨‍💻",
    content:
      "CodeQuest helped reignite my passion for coding after Holiday Hackathon. Since then I have connected with people who share similar interests as I do. It feels like home. Full credits to this platform on landing my first tech job!",
  },
  {
    name: "Evangelene",
    ...
    avatar: "👩‍💻",
    content:
      "The CodeQuest community feels like a comforting, hot cup of matcha latte on a cold rainy day. It's a warm and cozy space to be in despite our diverse backgrounds and beginnings.",
  },
] as Array<{
  name: string;
  role: string;
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="relative z-10 flex flex-col">
          ...
          >
            <div className="container mx-auto px-4">
              <header className="max-w-4xl mx-auto text-center">
                {/* Animated Badge */}
                <div
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/90 to-pink-500/90 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium border border-purple-600 mb-8 animate-[bounce_2s_infinite]"
                  aria-live="polite"
                >
                ...
                <p className="text-lg md:text-xl text-slate-700 max-w-2xl mx-auto mb-10 leading-relaxed">
                  Learn to code through gamified interactive adventures.
                  Complete bite-sized lessons, earn XP, and build real-world
                  projects while having fun!
                </p>
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      handleStartCourse("/courses/javascript/learn")
                    }
          ...
          {/* Stats Section */}
          <section
            className="py-12 border-y border-purple-300/30 bg-white/70 backdrop-blur-sm"
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                  ...
                  <div key={index} className="text-center group" role="group">
                    <div
                      className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center mx-auto mb-3 border border-purple-400/40 group-hover:border-purple-500/60 transition-all"
                      aria-hidden="true"
                    >
            ...
            <div className="container mx-auto px-4">
              <header className="text-center mb-16">
                ...
                <p className="text-lg text-slate-700 max-w-2xl mx-auto">
                  Learn programming in a fun way with interactive challenges and
                  rewards
                </p>
              </header>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
                {memoizedFeatures.map((feature, index) => (
                  <article
                    key={index}
                    className="text-center group hover:scale-105 transition-all duration-300 bg-white/80 backdrop-blur-sm border border-slate-300/50 hover:border-slate-400 hover:shadow-lg"
                  >
                    <Card>
                      <CardHeader>
                        <div
                          className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center mx-auto mb-4 border border-purple-400/30 group-hover:scale-110 transition-transform"
                          aria-hidden="true"
                        >
                          {feature.icon}
                        </div>
          ...
          {/* Courses Section */}
          <section
            className="py-24 bg-white/70 backdrop-blur-sm border-y border-purple-300/30"
                    ...
                    <Card className="bg-white/80 backdrop-blur-sm border-2 border-slate-300/50 hover:border-slate-500/60 hover:shadow-xl hover:shadow-purple-500/20">
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          <div
                            className={`p-6 rounded-2xl bg-gradient-to-br ${course.color} text-white shadow-lg group-hover:scale-110 transition-transform`}
                            aria-hidden="true"
                          >
                      ...
                      <CardContent>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2 text-sm text-slate-600">
                            <BookOpen className="h-4 w-4" aria-hidden="true" />
                            <span
                              aria-label={`${course.lessons} lessons available`}
                            >
                              {course.lessons} lessons
                            </span>
                          </div>
                          <ArrowRight
                            className="h-5 w-5 text-purple-600 group-hover:translate-x-1 group-hover:text-purple-700 transition-all focus-within:translate-x-1 focus-within:text-purple-700"
                            aria-hidden="true"
                          />
                        </div>
                      </CardContent>
                ...
                fallback={
                  ...
                  >
                    {[1, 2].map((i) => (
                      <Card
                        key={i}
                        className="animate-pulse bg-white/80 backdrop-blur-sm border border-slate-300/50"
                      >
                        <CardContent
                          className="h-64"
                          aria-hidden="true"
          ...
          {/* CTA Section */}
          <section
            className="py-24 bg-gradient-to-r from-purple-700/80 to-pink-700/80 backdrop-blur-sm"
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-lg md:text-xl text-purple-200 mb-10 max-w-2xl mx-auto leading-relaxed">
                  Start your coding journey today for free. No credit card
                  required. Learn at your own pace, build real projects, and
                ...
                <div className="flex flex-wrap justify-center gap-8 mt-12 text-sm text-purple-200">
                  <div className="flex items-center gap-2">
                    <div
                      ...
                      aria-label="Community indicator"
                      aria-hidden="true"
                    >
                      {[1, 2, 3, 4, 5].map((i) => (
                        <div
                    ...
                    <span aria-label="10,000 plus learners">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      ...
                      aria-label="4.9 out of 5 star rating"
                    >
                      4.9/5 rating
                    </span>
                  </div>
            ...
            <div className="container mx-auto px-4 py-12">
              <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-3">
                  <div
                    className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center text-white shadow-lg"
                    aria-hidden="true"
                  >
                ...
                >
                  <Link
                    href="/courses"
                    className="hover:text-purple-700 transition-colors font-medium focus:underline underline-offset-4"
                  >
                    Courses
                  </Link>
                  <Link
              ...
              <div className="mt-8 pt-8 border-t border-purple-300/30 text-center">
                <p className="text-sm text-slate-600">
                  © 2024 CodeQuest. All rights reserved. Made with ❤️ for
                  learners everywhere.
                </p>
              </div>
            </div>
