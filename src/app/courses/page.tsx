...
import { Play, Star, Users, Clock, Flame, Award, TrendingUp, BookOpen, Terminal, Zap, Sparkles, ChevronRight, Search, ArrowUpRight, CheckCircle2, Globe, Heart, Share2 } from 'lucide-react'
...
const courses: Course[] = [
  {
    ...
    description: 'Master JavaScript from basics to advanced concepts including ES6+, Async/Await, and modern patterns.',
    level: 'All Levels',
    lessons: 5,
    duration: '4 hours',
    students: 15420,
  ...
  },
  {
    ...
    description: 'Learn Python through fun and engaging challenges from basics to OOP and data structures.',
    level: 'All Levels',
    lessons: 5,
    duration: '4.5 hours',
    students: 12850,
  ...
  },
  {
    ...
    description: 'Build modern web applications with React hooks, components, state management, and performance optimization.',
    level: 'Intermediate',
    lessons: 4,
    duration: '6 hours',
    students: 9340,
  ...
  },
  {
    ...
    description: 'Create and consume REST APIs, handle authentication, validation, and master backend architecture.',
    level: 'Advanced',
    lessons: 3,
    duration: '5 hours',
    students: 5420,
  ...
  },
  {
    ...
    description: 'Master TypeScript for safer, more scalable JavaScript applications with advanced typing techniques.',
    level: 'Intermediate',
    lessons: 3,
    duration: '5.5 hours',
    students: 7890,
  ...
  },
  {
    ...
    description: 'Build server-side applications with Node.js, Express, real-time features, and microservices architecture.',
    level: 'Advanced',
    lessons: 3,
    duration: '6 hours',
    students: 6230,
  ...
  },
  {
    ...
    description: 'Complete web development journey from HTML basics to modern frameworks and deployment strategies.',
    level: 'Beginner',
    lessons: 3,
    duration: '10 hours',
    students: 21340,
  ...
  },
  {
    ...
    description: 'Learn SQL, MongoDB, PostgreSQL, and database design principles with real-world projects.',
    level: 'Intermediate',
    lessons: 3,
    duration: '4.5 hours',
    students: 4890,
...
const filterOptions = [
  ...
  { id: 'beginner', label: 'Beginner', icon: Sparkles, count: courses.filter(c => c.level === 'Beginner').length },
  { id: 'intermediate', label: 'Intermediate', icon: TrendingUp, count: courses.filter(c => c.level === 'Intermediate').length },
  { id: 'advanced', label: 'Advanced', icon: Award, count: courses.filter(c => c.level === 'Advanced').length },
  { id: 'popular', label: 'Popular', icon: Flame, count: courses.filter(c => c.popular || c.trending).length },
]
...
export default function CoursesPage() {
  ...
  const stats = [
    { icon: BookOpen, label: 'Courses', value: courses.length, color: 'from-amber-500 to-orange-500' },
    { icon: Users, label: 'Students', value: '82K+', color: 'from-emerald-500 to-teal-500' },
    { icon: Star, label: 'Rating', value: '4.8', color: 'from-yellow-500 to-amber-500' },
    { icon: Award, label: 'Certificates', value: '15K+', color: 'from-rose-500 to-pink-500' }
  ]
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <div className="font-bold text-gray-900 dark:text-white">CodeQuest</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Level Up Your Skills</div>
              </div>
            </div>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-slate-950">
        ...
        <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Choose from {courses.length}+ expertly crafted courses with interactive lessons, 
              real-world projects, and earn rewards as you learn.
            </p>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
            <path d="M0 120L60 105C120 90 240 60 360 45C480 30 600 30 720 37.5C840 45 960 60 1080 67.5C1200 75 1320 75 1380 75L1440 75V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0Z" fill="currentColor" className="text-slate-50 dark:text-gray-950" />
          </svg>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
          ...
          {stats.map((stat, index) => (
            ...
            >
              <CardContent className="p-6 text-center">
                <div className={`w-14 h-14 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${stat.color} flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredCourses.map((course, index) => (
            <Link key={course.id} href={`/courses/${course.id}/learn`} className="group">
              <Card 
              ...
              >
                ...
                <div className={`h-32 bg-gradient-to-br ${course.color} relative overflow-hidden`}>
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <Badge variant="secondary" className="bg-white/90 dark:bg-gray-900/90 text-gray-700 dark:text-gray-300 border-0 text-xs font-medium px-3 py-1 shadow-sm">
                      {course.category}
                    </Badge>
                  </div>
                </div>
                ...
                <CardContent className="p-5">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-gray-400 dark:text-gray-500">{course.lastUpdated}</span>
                      </div>
                    </div>
                    <Badge 
                      variant="outline" 
                      className={`text-xs font-medium border-2 ${
                        course.level === 'Beginner' ? 'bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950/30 dark:text-emerald-400 dark:border-emerald-800' :
                        course.level === 'Intermediate' ? 'bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-950/30 dark:text-amber-400 dark:border-amber-800' :
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    <div className="text-center p-2 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                      ...
                      <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">{course.lessons}</span>
                      <span className="block text-[10px] text-gray-400 dark:text-gray-500">lessons</span>
                    </div>
                    <div className="text-center p-2 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                      <Clock className="h-3.5 w-3.5 mx-auto mb-1 text-gray-500 dark:text-gray-400" />
                      <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">{course.duration}</span>
                      <span className="block text-[10px] text-gray-400 dark:text-gray-500">duration</span>
                    </div>
                    <div className="text-center p-2 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                      ...
                      <span className="block text-[10px] text-gray-400 dark:text-gray-500">rating</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-800">
                    ...
                    <div className={`flex items-center gap-1.5 text-sm font-bold bg-gradient-to-r ${course.color} bg-clip-text text-transparent`}>
                  ...
                  {/* Hover Arrow */}
                  <div className={`absolute bottom-4 right-4 w-10 h-10 rounded-xl bg-gradient-to-r ${course.color} flex items-center justify-center text-white shadow-lg transform translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300`}>
            ...
            {[
              {
                ...
                image: '👩‍💻',
                story: 'From complete beginner to landing my dream job at Google. CodeQuest gave me the hands-on experience I needed.',
                courses: 12,
                xp: 4500,
                time: '8 months'
              },
              {
                ...
                image: '👨‍💻',
                story: 'The project-based learning approach helped me build a portfolio that impressed recruiters.',
                courses: 8,
                xp: 3200,
                time: '6 months'
              },
              {
                ...
                image: '👩‍🎨',
                story: 'CodeQuest filled the gaps in my knowledge and gave me the confidence to lead major projects.',
                courses: 15,
                xp: 5800,
                time: '10 months'
              }
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-amber-400 text-sm font-medium">{story.role}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                  <div className="text-xs text-gray-400">
                    <span className="text-white font-semibold">{story.courses}</span> courses
                  </div>
                  <div className="text-xs text-gray-400">
                    <span className="text-white font-semibold">{story.xp} XP</span> earned
                  </div>
                  <div className="text-xs text-gray-400">
                    <span className="text-white font-semibold">{story.time}</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                >
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${path.color} flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform`}>
                    {path.icon}
                  </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="font-bold text-gray-900 dark:text-white text-lg">CodeQuest</div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">Level Up Your Skills</div>
                </div>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm max-w-md mb-4">
                Learn coding through interactive courses, real-world projects, and earn rewards as you progress.
              </p>
            ...
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-white mb-4">Courses</h4>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">JavaScript</li>
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">Python</li>
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">React</li>
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">Backend</li>
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">Database</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">About Us</li>
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">Contact</li>
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">Careers</li>
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">Blog</li>
                <li className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition-colors">Support</li>
              </ul>
            </div>
          </div>
