      ...
      <div className="container mx-auto px-4">
        <header className="text-center mb-16">
          ...
          <p className="text-lg text-slate-700 max-w-2xl mx-auto">
            Learn coding concepts through fun games! Practice logic, arrays, and
            win conditions.
          </p>
        </header>
        ...
        {!currentGame && (
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card
              className="group cursor-pointer hover:scale-105 transition-all duration-300 bg-white/80 backdrop-blur-sm border-2 border-green-500/30 hover:border-green-400/60 hover:shadow-xl hover:shadow-green-500/20"
              onClick={() => loadGame("reaction")}
            >
              <CardHeader>
              ...
              <CardContent>
                <p className="text-base text-slate-600 mb-4">
                  Test your reflexes! Click as fast as you can when the screen
                  turns green.
                </p>
            ...
            <Card
              className="group cursor-pointer hover:scale-105 transition-all duration-300 bg-white/80 backdrop-blur-sm border-2 border-purple-500/30 hover:border-purple-400/60 hover:shadow-xl hover:shadow-purple-500/20"
              onClick={() => loadGame("memory")}
            >
              <CardHeader>
              ...
              <CardContent>
                <p className="text-base text-slate-600 mb-4">
                  Learn array matching and state tracking. Find matching pairs
                  of cards!
                </p>
                <div className="flex items-center gap-2 text-sm text-slate-500">
                  <Flame className="h-4 w-4" />
            ...
            <Card
              className="group cursor-pointer hover:scale-105 transition-all duration-300 bg-white/80 backdrop-blur-sm border-2 border-red-500/30 hover:border-red-400/60 hover:shadow-xl hover:shadow-red-500/20"
              onClick={() => loadGame("ttt")}
            >
              <CardHeader>
              ...
              <CardContent>
                <p className="text-base text-slate-600 mb-4">
                  Master win condition checking. Beat the AI in this classic
                  strategy game!
                </p>
                <div className="flex items-center gap-2 text-sm text-slate-500">
                  <Flame className="h-4 w-4" />
              ...
              <div className="flex justify-center mb-4">
                <div className="grid grid-cols-4 gap-3">
                  {cards.map((card, i) => (
                    ...
                    >
                      {flippedCards.includes(i) || matchedPairs >= 8
                        ? card
                        : ""}
                    </button>
                  ))}
            ...
            <CardContent className="py-8">
              <div className="mb-4 text-center">
                ...
                <div className="inline-block bg-red-500/20 px-6 py-3 rounded-lg border border-red-500/50">
                  <span
                    className={`text-red-400 text-xl ${isAiThinking ? "animate-pulse" : ""}`}
                  >
                    {tttStatus}
                  </span>
                </div>
              ...
              {tttWinner && (
                <div className="text-center">
                  <div
                    className={`text-4xl font-bold mb-4 animate-pulse ${tttWinner === "X" ? "text-green-400" : "text-red-500"}`}
                  >
